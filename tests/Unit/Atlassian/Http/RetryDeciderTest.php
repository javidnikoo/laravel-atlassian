...
{
    public function test_it_retries_for_non_request_exception(): void
    {
        $this->assertTrue(RetryDecider::shouldRetry(new \RuntimeException('boom')));
    }

    public function test_it_retries_when_status_is_null(): void
    {
    ...
    public function test_it_retries_for_5xx(): void
    {
    ...
    public function test_it_does_not_retry_for_4xx(): void
    {
